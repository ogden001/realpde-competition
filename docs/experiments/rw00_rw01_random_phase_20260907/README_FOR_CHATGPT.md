...
Status: `STOP_EARLY` / `STOP_RANDOM_PHASE`.

Implementation commit: `aaa5e71baa1ac8bbb0ca37191a20fe3f5b27e8c1`.
...
RW-01 was stopped at @3000 because Rel-L2 and MVPE degradation both exceeded 3%; TKE also degraded strongly. @7500 RW-01 was therefore intentionally not run.
...
The requested trend `@1000≈baseline → @3000 small gain → @7500 gain` did not appear; RW-01 was substantially worse from the first checkpoint.
