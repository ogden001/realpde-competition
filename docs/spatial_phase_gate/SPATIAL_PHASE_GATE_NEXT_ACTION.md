# SPATIAL_PHASE_GATE_NEXT_ACTION - Execute Spatial Phase Gate V1
...
Scientific protocol is frozen in `README.md`; operational steps are frozen in `SPATIAL_PHASE_GATE_CODEX_EXECUTION.md`.
